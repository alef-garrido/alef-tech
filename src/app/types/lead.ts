...
export const FORM_CONFIG: Record<ServiceType, FormField[]> = {
  ...
  diagnostic: [
    ...
    },
    {
      ...
      required: true,
      options: [
        { value: 'under-5k', label: 'Menos de $5K USD' },
        { value: '5k-15k', label: '$5K - $15K USD' },
        { value: '15k-50k', label: '$15K - $50K USD' },
        { value: '50k+', label: '$50K+ USD' },
        { value: 'no-presupuesto', label: 'No tengo presupuesto definido' },
      ],
    },
    {
      name: 'timeline',
      label: '¿Cuándo necesitas implementar cambios?',
      type: 'select',
      required: true,
      options: [
        { value: 'asap', label: 'ASAP (próximas 2 semanas)' },
