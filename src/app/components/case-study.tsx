...
const COMPANIES: Company[] = [
  { id: 'hp', name: 'HP', logo: '/assets/logos/hp-1.svg', className: 'h-11 w-auto max-w-[75px]', filterClass: 'brightness-0 invert' },
  ...
  { id: 'walmart', name: 'Walmart', logo: '/assets/logos/walmart-6.svg', className: 'h-10 w-auto max-w-[160px]', filterClass: 'brightness-0 invert' },
            ...
            {marqueeItems.map((company, index) => (
              ...
              >
                <Image
                  ...
                  width={200}
                  height={50}
                  className={`object-contain opacity-85 hover:opacity-100 transition-opacity ${company.filterClass || 'grayscale invert brightness-125'} ${company.className || 'h-9 w-auto max-w-[140px]'}`}
                />
              </div>
            ))}
          </div>
